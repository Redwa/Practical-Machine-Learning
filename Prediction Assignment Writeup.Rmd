...
```{r}
require(caret)
seed <- as.numeric(as.Date("2015-10-25"))
set.seed(seed)
...
Write submission files to `Practical-Machine-Learning-files/answers`.

```{r}
pml_write_files = function(x){
  n = length(x)
  path <- "Practical-Machine-Learning-files/answers"
  for(i in 1:n){
